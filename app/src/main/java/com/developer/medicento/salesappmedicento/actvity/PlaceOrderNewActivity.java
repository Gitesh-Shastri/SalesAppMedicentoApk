...
import com.developer.medicento.salesappmedicento.NewArea;
import com.developer.medicento.salesappmedicento.NewPharmacy;
import com.developer.medicento.salesappmedicento.R;
import com.developer.medicento.salesappmedicento.SalesPersonDetails;
import com.developer.medicento.salesappmedicento.fragments.PlaceOrderAreaFragment;
import com.developer.medicento.salesappmedicento.fragments.PlaceOrderSelectMedicineFragment;
...
import com.developer.medicento.salesappmedicento.networking.data.SalesPerson;
...
public class PlaceOrderNewActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, PlaceOrderAreaFragment.OnPlaceOrderChangeListener,
        PlaceOrderSelectMedicineFragment.OnPlaceOrderAreaChangeListener {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(
                        new Intent(
                                Intent.ACTION_VIEW,
                                Uri.parse("https://play.google.com/store/apps/details?id=com.developer.medicento.salesappmedicento"
                                )
                        )
                );
            }
