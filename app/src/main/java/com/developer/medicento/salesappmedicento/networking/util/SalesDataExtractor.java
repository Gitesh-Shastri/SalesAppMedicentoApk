package com.developer.medicento.salesappmedicento.networking.util;
...
public class SalesDataExtractor {
    ...
    public static Object initiateConnection(String stringUrl, String action, Context ctxt, ArrayList<OrderedMedicine> data, String pharmaId, String id, String slot) {
        String jsonResponse = "";
        ...
        if (action.equals(ctxt.getString(R.string.login_action)))  {
            ...
            String jsonData = extractJsonFromOrderItemsList(data, url, pharmaId, id, slot);
            try {
    ...
    private static String extractJsonFromOrderItemsList(ArrayList<OrderedMedicine> data, URL url, String pharmaId, String id, String slot) {
